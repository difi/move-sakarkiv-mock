...
let payload = (jpId, jpJaar, jpSeknr, jpJpostnr, jpJdato, jpDokdato, amOrgnr, amNavn, saSaar, saSeknr, saDato, saArkdel, dbTittel, saOfftittel) => {
...
<Melding xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.arkivverket.no/Noark4-1-WS-WD/types">
  <journpost xmlns="">
    ...
    <jpStatus>R</jpStatus>
    <jpInnhold>{Hentes fra tittelfelt på webside}</jpInnhold>
    <jpForfdato />
    <jpTgkode>U</jpTgkode>
    <jpAgdato />
    <jpAntved />
